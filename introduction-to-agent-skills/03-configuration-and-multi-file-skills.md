...
topics: [metadata fields and allowed-tools, writing effective descriptions, progressive disclosure, multi-file skill organization, scripts and context efficiency]
---
...
In this approach, Claude reads supporting files only when someone asks about that topic. If they're asking where to add a component, it never loads architecture documentation. It's like having a table of contents in the context window rather than the entire document.
