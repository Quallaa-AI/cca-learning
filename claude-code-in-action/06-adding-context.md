...
Use the `#` command to enter "memory mode" - this lets you edit your CLAUDE.md files intelligently. Just type something like your instruction and Claude will merge it into your CLAUDE.md file automatically.
